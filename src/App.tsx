    ...
    <section id="about" className="hero">
      <div className="hero-inner">
        <div className="hero-text">
          ...
          <a className="interactive-link" href="/interactive/">
            ...
            <span className="interactive-text">Want something more interactive?</span>
            <span className="interactive-arrow" aria-hidden="true">→</span>
          </a>
